...
namespace Xamarin.CommunityToolkit.UI.Views
{
	...
	public class Shield : BaseTemplatedView<Frame>
	{
		...
		/// <summary>
		/// Background <see cref="Microsoft.Maui.Color" /> of the left side of the <see cref="Shield" />. This is a bindable property.
		/// </summary>
		...
		/// <summary>
		/// Text <see cref="Microsoft.Maui.Color" /> of the text on the right side of the Shield
		/// </summary>
		...
		/// <summary>
		/// Background <see cref="Microsoft.Maui.Color" /> of the right side of the <see cref="Shield" />. This is a bindable property.
		/// </summary>
